...
void PrintAbsyn::visitVarAss(VarAss* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitVarDec(VarDec* p)
{
  int oldi = _i_;
  if (oldi > 0) render(_L_PAREN);
...
void ShowAbsyn::visitDecA(DecA* p)
{
  bufAppend('(');
  bufAppend("DecA");
  bufAppend(' ');
...
void ShowAbsyn::visitVarAss(VarAss* p)
{
  bufAppend('(');
  bufAppend("VarAss");
  bufAppend(' ');
...
void ShowAbsyn::visitVarDec(VarDec* p)
{
  bufAppend('(');
  bufAppend("VarDec");
  bufAppend(' ');
