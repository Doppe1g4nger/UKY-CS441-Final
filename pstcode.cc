...
{
	fvsyms.insert(Symbol("puts", TY_FUNC, 1, pos(), TY_INT));
	add(I_VARIABLE);
	add(0);
	add(-1);
	add(I_VALUE);
	...
	fvsyms.insert(Symbol("putn", TY_FUNC, 1, pos(), TY_INT));
	add(I_VARIABLE);
	add(0);
	add(-1);
	add(I_VALUE);
	...
	add(1);
        ...
        fvsyms.insert(Symbol("getnum", TY_FUNC, -1, pos(), TY_BAD));
        add(I_VARIABLE);
        add(0);
        add(-1);
        add(I_READ);
	...
	fvsyms.insert(Symbol("exit", TY_FUNC,-1, pos(), TY_BAD));
	add(I_ENDPROG);
